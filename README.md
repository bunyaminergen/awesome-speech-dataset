...
| **SPGISpeech (Kensho)**                                | [Download Data](https://www.kensho.com/dataset)                                                    | 5,000 hours of professionally-transcribed financial audio from earnings calls; ideal for ASR research in the financial domain.                                  |    True    |
| **ASR Datasets**                                       | [GitHub ASR_Audio_Data_Links](https://github.com/robmsmt/ASR_Audio_Data_Links)                     | A list of publicly available audio datasets for ASR and related speech activities.                                                                              |    True    |
...
| **DIPCO**                                              | [DIPCO](https://arxiv.org/abs/1909.13447)                                                          | Dinner Party Corpus – recordings via close‐talk and far‐field arrays from 10 sessions (15–45 minutes each).                                                     |    True    |
...
| Dataset                    | Download                                                                          | Description                                                                                                     | OpenSource |
|----------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|:----------:|
| **VoxCeleb1**              | [VoxCeleb1](http://www.robots.ox.ac.uk/~vgg/data/voxceleb/)                       | 140k utterances from 1,251 speakers (≈352 hours) from celebrity interviews on YouTube.                          |    True    |
| **VoxCeleb2**              | [VoxCeleb2](http://www.robots.ox.ac.uk/~vgg/data/voxceleb/vox2.html)              | Over 1 million utterances from 6,112 speakers (~2,442 hours) for state-of-the-art speaker recognition research. |    True    |
...
| **VoxConverse**                    | [VoxConverse](https://www.robots.ox.ac.uk/~vgg/data/voxconverse/)                             | Speaker diarization dataset with challenging conversational speech from YouTube videos.                                   |    True    |
